...
myApp.controller("appCtrl", function($scope, importIo, $window) {
    ...
    {location: "Prenzlauerberg", 
     ...
     $scope.getResults = function(city){
      ...
      $scope.getMoreResults = function(city,page){
           $scope.page++;
           page++;
           $scope.flats.length = 0;
...
myApp.factory("importIo", function($http) {
    ...
    return {
         ...
         getData2: function(city,page) {
            ...
            if(page == undefined) {
               url = "https://api.import.io/store/data/b98811cb-d0d2-4d75-b592-fea4b25d424e/_query?input/webpage/url=https%3A%2F%2Fwww.dreamflat.de%2Fwg-"+city+"%2F&_user=edbab12f-9a27-4416-b538-7c8981e8bf15&_apikey=apikeyhere";
            }
            else {
               url = "https://api.import.io/store/data/b98811cb-d0d2-4d75-b592-fea4b25d424e/_query?input/webpage/url=https%3A%2F%2Fwww.dreamflat.de%2Fwg-"+city+"%2F%3Fpage%3D"+page+"&_user=edbab12f-9a27-4416-b538-7c8981e8bf15&_apikey=apikeyhere";
            }
            return $http({method:"GET", 
                  url:url      
                  });
